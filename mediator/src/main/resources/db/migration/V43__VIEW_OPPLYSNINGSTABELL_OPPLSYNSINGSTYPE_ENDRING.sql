UPDATE opplysningstype SET uuid = gen_random_uuid() WHERE uuid IS NULL;
ALTER TABLE opplysningstype ALTER COLUMN uuid SET NOT NULL;
ALTER TABLE opplysningstype DROP CONSTRAINT f;
ALTER TABLE opplysningstype ADD CONSTRAINT unik_id UNIQUE (uuid, datatype);
ALTER TABLE opplysningstype RENAME COLUMN id TO behov_id;
