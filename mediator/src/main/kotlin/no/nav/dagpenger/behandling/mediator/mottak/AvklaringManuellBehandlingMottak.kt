...
internal class AvklaringManuellBehandlingMottak(
    ...
    init {
        River(rapidsConnection).apply {
            ...
            validate { it.demandAllOrAny("@behov", listOf(AvklaringManuellBehandling.name)) }
...
internal class ManuellBehandlingAvklartMessage(private val packet: JsonMessage) : HendelseMessage(packet) {
