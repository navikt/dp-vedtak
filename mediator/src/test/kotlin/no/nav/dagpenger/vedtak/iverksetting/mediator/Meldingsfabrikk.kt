...
internal fun utbetalingsvedtakFattetNårDetFinnesTidligereUtbetalinger(ident: String, vedtakId: UUID, behandlingId: UUID, sakId: String, forrigeBehandlingId: UUID) =
    //language=JSON
    """
        {
          "@event_name": "utbetaling_vedtak_fattet",
