...
object Minsteinntekt {
    ...
    val inntekt12 = Opplysningstype.somBeløp("Arbeidsinntekt siste 12 mnd".id("InntektSiste12Mnd"))
    val inntekt36 = Opplysningstype.somBeløp("Arbeidsinntekt siste 36 mnd".id("InntektSiste36Mnd"))
    ...
    private val `12mndTerskel` = Opplysningstype.somBeløp("Inntektskrav for siste 12 mnd")
    private val `36mndTerskel` = Opplysningstype.somBeløp("Inntektskrav for siste 36 mnd")
