...
graph RL
  ...
  FE["Samordnet fastsatt arbeidstid"] -->|"Substraksjon"| FF["Beregnet vanlig arbeidstid per uke før tap"]
  FE["Samordnet fastsatt arbeidstid"] -->|"Substraksjon"| FD["Antall timer arbeidstiden skal samordnes mot"]
  ...
  GK["Fastsatt arbeidstid per uke før tap"] -->|"MinstAv"| FE["Samordnet fastsatt arbeidstid"]
