...
graph RL
  ...
  R["For medlem som har følgende reduserte ytelser fra folketrygden samme dag"] -->|"EnAv"| H["Uføretrygd etter lovens kapittel 12"]
  R["For medlem som har følgende reduserte ytelser fra folketrygden samme dag"] -->|"EnAv"| F["Foreldrepenger etter lovens kapittel 14"]
  R["For medlem som har følgende reduserte ytelser fra folketrygden samme dag"] -->|"EnAv"| G["Svangerskapspenger etter lovens kapittel 14"]
```
