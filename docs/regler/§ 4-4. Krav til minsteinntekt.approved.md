...
```mermaid
  ...
  E["InntektId"] -->|"Ekstern"| D["Siste avsluttende kalendermåned"]
  E["InntektId"] -->|"Ekstern"| C["Opptjeningsperiode"]
  F["Grunnbeløp"] -->|"Oppslag"| B["Søknadstidspunkt"]
  G["Arbeidsinntekt siste 12 mnd"] -->|"Ekstern"| E["InntektId"]
  ...
  K["Arbeidsinntekt siste 36 mnd"] -->|"Ekstern"| E["InntektId"]
