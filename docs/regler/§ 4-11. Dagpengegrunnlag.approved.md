...
graph RL
  ...
  Y["Grunnlag"] -->|"Avrund"| W["Uavrundet grunnlag"]
  Z["Har avkortet grunnlaget i periode 1"] -->|"StørreEnn"| L["Inntektperiode 1"]
  Z["Har avkortet grunnlaget i periode 1"] -->|"StørreEnn"| D["6 ganger grunnbeløp"]
  AA["Har avkortet grunnlaget i periode 2"] -->|"StørreEnn"| M["Inntektperiode 2"]
  AA["Har avkortet grunnlaget i periode 2"] -->|"StørreEnn"| D["6 ganger grunnbeløp"]
  AB["Har avkortet grunnlaget i periode 3"] -->|"StørreEnn"| N["Inntektperiode 3"]
  AB["Har avkortet grunnlaget i periode 3"] -->|"StørreEnn"| D["6 ganger grunnbeløp"]
  AC["Har avkortet grunnlag"] -->|"EnAv"| Z["Har avkortet grunnlaget i periode 1"]
  AC["Har avkortet grunnlag"] -->|"EnAv"| AA["Har avkortet grunnlaget i periode 2"]
  AC["Har avkortet grunnlag"] -->|"EnAv"| AB["Har avkortet grunnlaget i periode 3"]
```
