...
graph RL
  ...
  X["Har samordnet"] -->|"ErUlik"| T["Andel av dagsats med barnetillegg avkortet til maks andel av dagpengegrunnlaget"]
  ...
  Y["Ukessats med barnetillegg etter samordning"] -->|"Multiplikasjon"| J["Antall arbeidsdager per uke"]
  Z["Har barnetillegg"] -->|"StørreEnnEllerLik"| L["Sum av barnetillegg"]
  Z["Har barnetillegg"] -->|"StørreEnnEllerLik"| K["Barnetilleggets størrelse i kroner per dag for hvert barn"]
```
